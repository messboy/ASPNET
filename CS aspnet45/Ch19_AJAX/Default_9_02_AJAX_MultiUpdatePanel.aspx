<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default_9_02_AJAX_MultiUpdatePanel.aspx.cs" Inherits="Book_Sample_Ch19_AJAX_Default_9_02_AJAX_MultiUpdatePanel" %>
...
<body>
    ...
    <div>
        ...
        2). 頁面上, 三個<span class="style1">獨立的</span> UpdatePanel<br />
        <br />
        設定<span class="style5">每一個 UpdatePanel的[ChildrenAsTriggers]與[UpdateMode]兩大屬性</span>之後
         
        <br />
        還是有問題!!......所有時間都靜止了....不會動<br />
