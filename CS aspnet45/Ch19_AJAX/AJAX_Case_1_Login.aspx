<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AJAX_Case_1_Login.aspx.cs" Inherits="Ch19_AJAX_AJAX_Case_1_Login" %>
...
<body>
    ...
    <p>
        <span class="style1">聊天室[<span class="style2">AJAX版</span>]</span>，應用Application與Session的最好範例。</p>
        <hr />
    <p>
