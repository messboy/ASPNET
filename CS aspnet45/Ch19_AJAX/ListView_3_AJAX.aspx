<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListView_3_AJAX.aspx.cs" Inherits="Ch19_AJAX_ListView_3" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>加入選取按鈕 -- Master-Detail (AJAX)</title>
    <style type="text/css">
        .style1
        {
            color: #0033CC;
...
<body>
    ...
    這個 ListView控制項，Master-Detail<span class="style3"> (AJAX)</span><br />
    <span class="style2">加入選取按鈕之後，畫面有些地方會歪掉，必須自己動手整理一下HTML碼。這可能是VS 2008的小缺失。</span> 
     <br />
     <br />
     <br />
        ...
        <AlternatingItemTemplate>
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>          
                            ...
                            <asp:Button ID="EditButton2" runat="server" CommandName="Edit" Text="Edit" />&nbsp;
                            <asp:Button ID="DeleteButton2" runat="server" CommandName="Delete" Text="Delete" />&nbsp;
                            <asp:Button ID="Button22" runat="server" Text="選取（Select）" CommandName="Select"  />       
                            <hr />
                            </span>
                    </ContentTemplate>               
                </asp:UpdatePanel>
