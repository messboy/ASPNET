<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GridView_Template_Delete_PopUp.aspx.cs" Inherits="Book_Sample_Ch19_AJAX_GridView_Template_Delete_PopUp" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>刪除（需再次確認）</title>
</head>
<body>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField ShowHeader="False">
                                ...
                                <ItemTemplate>
                                    ...
                                    &nbsp;<asp:Button ID="Button2" runat="server" CausesValidation="False" 
                                        CommandName="Delete" Text="刪除（需再次確認）" 
                                        OnClientClick="return confirm('再一次確認，您要刪除這筆資料嗎？')" />
                                </ItemTemplate>
                            </asp:TemplateField>
