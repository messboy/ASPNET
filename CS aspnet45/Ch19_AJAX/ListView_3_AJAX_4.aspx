<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListView_3_AJAX_4.aspx.cs" Inherits="Book_Sample_Ch19_AJAX_ListView_3_AJAX_4" %>
...
<body>
    ...
    這個 ListView控制項，Master-Detail（主細表），<span class="style5">成功！！</span><br />
    <br />
    ...
    UpdatePanel<br />
    <br />
    <span class="style6">成功！！&nbsp;&nbsp;&nbsp; 成功！！&nbsp; 三個樣版裡面的 
    UpdatePanel必須是相同 ID！</span><br />
     <br />
     <br />
