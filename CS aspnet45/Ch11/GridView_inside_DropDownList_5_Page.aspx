<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GridView_inside_DropDownList_5_Page.aspx.cs" Inherits="Book_Sample_Ch11_GridView_inside_DropDownList_5_Page" %>
...
<body>
    ...
    <div>
    <br />
    科學小飛俠 #5 <span class="style2">（分頁）</span>  ---- <br />
    ...
    <hr />
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            ...
            BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="id" 
             GridLines="Horizontal" PageSize="3" AllowSorting="True" 
