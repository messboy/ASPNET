...
public partial class Book_Sample_CaseStudy_FoodCalorie_Food_Calorie_Calculator : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            Conn.Open();   //---- 這時候才連結DB
            int food_calorie = Convert.ToInt32(cmd.ExecuteScalar());   //---- 這時候執行SQL指令，取出資料
